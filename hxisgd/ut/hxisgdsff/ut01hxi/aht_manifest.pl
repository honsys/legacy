...
input => {
  ...
  default => "01ahHXI_tlm.fits", 
  valvec => ["01ahHXI_tlm.fits", "HXI_FF2012June.tpl", "HXI_SF2012June.tpl"]
},   
#   
...
expected_output => {   
  ...
  default => "001ahHXI_tlm_extract.fits",   
  valvec => ["001ahHXI_tlm_extract.fits"]   
},   
#   
