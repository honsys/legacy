...
#define HXITEMPLATE_C const char hxitemplate_rcsId_svnId[] = "$Id: HXItemplate.cxx,v 1.8 2012/08/16 19:27:34 dhon Exp $"; 
...
namespace {
  const string cvsId = "$Name:  $ $Id: HXItemplate.cxx,v 1.8 2012/08/16 19:27:34 dhon Exp $";
}
