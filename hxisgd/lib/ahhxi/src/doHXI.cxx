#if !defined(DOHXI_C)
#define DOHXI_C const char doHXI_rcsId_svnId[] = "$Id: doHXI.cxx,v 1.15 2012/08/16 19:27:35 dhon Exp $"; 
...
namespace {
  const string cvsId = "$Name:  $ $Id: doHXI.cxx,v 1.15 2012/08/16 19:27:35 dhon Exp $";
