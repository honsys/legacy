#if !defined(IOHXI_C)
#define IOHXI_C const char ioHXI_rcsId_svnId[] = "$Id: ioHXI.cxx,v 1.7 2012/08/13 21:22:00 dhon Exp $"; 
...
namespace {
  const string cvsId = "$Name:  $ $Id: ioHXI.cxx,v 1.7 2012/08/13 21:22:00 dhon Exp $";
