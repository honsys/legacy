#if !defined(LUTHXI_C)
#define LUTHXI_C const char lutHXI_rcsId_svnId[] = "$Id: lutHXI.cxx,v 1.4 2012/08/13 21:22:00 dhon Exp $"; 
...
namespace {
  const string cvsId = "$Name:  $ $Id: lutHXI.cxx,v 1.4 2012/08/13 21:22:00 dhon Exp $";
...
namespace ahhxi {
  ...
  int asicCountOffset() { return HXI_Occurrence_HeaderSizeInBytes - 2; }
  ...
  int firstEventOffset() { return HXI_Occurrence_HeaderSizeInBytes; } 

  int firstActvChanFlagOffset() { return HXI_Occurrence_HeaderSizeInBytes + 2; } 
  ...
  // HXI as an "occurrence" vector-list Bit32 items. (SGD func must provide Bit64 items)
